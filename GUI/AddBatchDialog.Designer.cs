...
partial class AddBatchDialog
{
    ...
    private void InitializeComponent()
    {
        ...
        labelHeaderTitle.Text = "Nhập thêm lô hàng";
        //
        // labelMedicineName
        //
        ...
        // _btnSave
        //
        _btnSave.BackColor = Color.FromArgb(0, 123, 255);
        ...
        _btnSave.HoverBackColor = Color.FromArgb(0, 105, 217);
        _btnSave.Location = new Point(312, 406);
        _btnSave.Size = new Size(124, 36);
        _btnSave.Text = "Lưu lô hàng";
